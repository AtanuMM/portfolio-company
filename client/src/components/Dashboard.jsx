                            ...
                            <List>
                                {[''].map((text, index) => (
                                    <ListItem key={text} disablePadding>
                                        <ListItemButton>
                                            <NavLink to='/projectregistration'> <button className="btn btn-secondary">add project</button></NavLink>
                                            {/* <ListItemIcon>
                {index % 2 === 0 ? <InboxIcon /> : <MailIcon />}
                            ...
                            <List>
                                {[''].map((text, index) => (
                                    <ListItem key={text} disablePadding>
                                        <ListItemButton>
                                            <NavLink to='/viewproj'> <button className="btn btn-secondary">view project</button></NavLink>
                                            {/* <ListItemIcon>
                {index % 2 === 0 ? <InboxIcon /> : <MailIcon />}
              </ListItemIcon> */}
                                            <ListItemText primary={text} />
